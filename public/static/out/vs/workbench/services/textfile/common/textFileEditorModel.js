...
define(["require", "exports", "vs/nls", "vs/base/common/event", "vs/base/common/types", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/common/editor/textEditorModel", "vs/workbench/services/backup/common/backup", "vs/platform/files/common/files", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/base/common/async", "vs/platform/notification/common/notification", "vs/platform/log/common/log", "vs/base/common/path", "vs/workbench/services/workingCopy/common/workingCopyService", "vs/workbench/services/filesConfiguration/common/filesConfigurationService", "vs/platform/label/common/label", "vs/base/common/cancellation"], function (require, exports, nls, event_1, types_1, textfiles_1, textEditorModel_1, backup_1, files_1, modeService_1, modelService_1, async_1, notification_1, log_1, path_1, workingCopyService_1, filesConfigurationService_1, label_1, cancellation_1) {
    "use strict";
    ...
    let TextFileEditorModel = class TextFileEditorModel extends textEditorModel_1.BaseTextEditorModel {
        ...
        preferredMode, // mode as chosen by the user
        notificationService, modeService, modelService, fileService, textFileService, backupFileService, logService, workingCopyService, filesConfigurationService, labelService) {
            ...
            //#endregion
            this.capabilities = 0;
            this.name = path_1.basename(this.labelService.getUriLabel(this.resource));
            this.versionId = 0;
        ...
        async backup() {
            ...
            return { meta, content: types_1.withNullAsUndefined(this.createSnapshot()) };
        }
        //#endregion
        //#region Revert
        ...
        async loadFromBackup(backup, options) {
        ...
        async loadFromFile(options) {
            const forceReadFromDisk = options === null || options === void 0 ? void 0 : options.forceReadFromDisk;
        ...
        loadFromContent(content, options, fromBackup) {
            ...
            // Emit as event
            this._onDidLoad.fire((_a = options === null || options === void 0 ? void 0 : options.reason) !== null && _a !== void 0 ? _a : 3 /* OTHER */);
            return this;
        }
        ...
        async doSave(options) {
            ...
            return this.saveSequentializer.setPending(versionId, (async () => {
                ...
                if (this.isResolved() && !options.skipSaveParticipants) {
                    try {
                        await this.textFileService.files.runSaveParticipants(this, { reason: (_a = options.reason) !== null && _a !== void 0 ? _a : 1 /* EXPLICIT */ }, saveCancellation.token);
                    }
                    catch (error) {
                ...
                if (options.force && !this.dirty && !this.inOrphanMode && options.reason === 1 /* EXPLICIT */ && versionId === this.versionId) {
                ...
                const lastResolvedFileStat = types_1.assertIsDefined(this.lastResolvedFileStat);
                ...
                return this.saveSequentializer.setPending(versionId, (async () => {
                    try {
                        const stat = await this.textFileService.write(lastResolvedFileStat.resource, textFileEdiorModel.createSnapshot(), {
                            ...
                            etag: (options.ignoreModifiedSince || !this.filesConfigurationService.preventSaveConflicts(lastResolvedFileStat.resource, textFileEdiorModel.getMode())) ? files_1.ETAG_DISABLED : lastResolvedFileStat.etag,
...
//# __sourceMappingURL=textFileEditorModel.js.map