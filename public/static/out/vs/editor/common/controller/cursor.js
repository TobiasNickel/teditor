 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/errors", "vs/base/common/strings", "vs/editor/common/controller/cursorCollection", "vs/editor/common/controller/cursorCommon", "vs/editor/common/controller/cursorDeleteOperations", "vs/editor/common/controller/cursorTypeOperations", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/view/viewEvents", "vs/base/common/lifecycle", "vs/editor/common/viewModel/viewModelEventDispatcher"], function (require, exports, errors_1, strings, cursorCollection_1, cursorCommon_1, cursorDeleteOperations_1, cursorTypeOperations_1, range_1, selection_1, viewEvents_1, lifecycle_1, viewModelEventDispatcher_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Cursor = exports.CursorModelState = void 0;
    /**
    ...
    class Cursor extends lifecycle_1.Disposable {
        constructor(model, viewModel, coordinatesConverter, cursorConfig) {
            ...
            this.context = new cursorCommon_1.CursorContext(this._model, this._coordinatesConverter, cursorConfig);
        ...
        setSelections(eventsCollector, source, selections) {
            this.setStates(eventsCollector, source, 0 /* NotSet */, cursorCommon_1.CursorState.fromModelSelections(selections));
        }
        ...
        endComposition(eventsCollector, source) {
            this._executeEdit(() => {
                if (source === 'keyboard') {
                    ...
                    this._executeEditOperation(cursorTypeOperations_1.TypeOperations.compositionEndWithInterceptors(this._prevEditOperationType, this.context.cursorConfig, this._model, this._selectionsWhenCompositionStarted, this.getSelections(), autoClosedCharacters));
                    this._selectionsWhenCompositionStarted = null;
                }
            ...
            this._executeEdit(() => {
                if (source === 'keyboard') {
                    ...
                    while (offset < len) {
                        ...
                        const autoClosedCharacters = AutoClosedAction.getAllAutoClosedCharacters(this._autoClosedActions);
                        this._executeEditOperation(cursorTypeOperations_1.TypeOperations.typeWithInterceptors(this._isDoingComposition, this._prevEditOperationType, this.context.cursorConfig, this._model, this.getSelections(), autoClosedCharacters, chr));
                        offset += charLength;
                    }
                }
                else {
        ...
        replacePreviousChar(eventsCollector, text, replaceCharCnt, source) {
            this._executeEdit(() => {
                this._executeEditOperation(cursorTypeOperations_1.TypeOperations.replacePreviousChar(this._prevEditOperationType, this.context.cursorConfig, this._model, this.getSelections(), text, replaceCharCnt));
            }, eventsCollector, source);
        }
...
//# __sourceMappingURL=cursor.js.map