 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/event", "vs/base/common/strings", "vs/editor/common/core/range", "vs/editor/common/model", "vs/editor/common/model/pieceTreeTextBuffer/pieceTreeBase", "vs/editor/common/model/tokensStore", "vs/editor/common/model/textChange"], function (require, exports, event_1, strings, range_1, model_1, pieceTreeBase_1, tokensStore_1, textChange_1) {
    "use strict";
    ...
    class PieceTreeTextBuffer {
        ...
        applyEdits(rawOperations, recordTrimAutoWhitespace, computeUndoEdits) {
            ...
            for (let i = 0; i < rawOperations.length; i++) {
                ...
                if (op.text) {
                    let strEOL;
                    [eolCount, firstLineLength, lastLineLength, strEOL] = tokensStore_1.countEOL(op.text);
        ...
        _toSingleEditOperation(operations) {
            ...
            const [eolCount, firstLineLength, lastLineLength] = tokensStore_1.countEOL(text);
            return {
                sortIndex: 0,
...
//# __sourceMappingURL=pieceTreeTextBuffer.js.map