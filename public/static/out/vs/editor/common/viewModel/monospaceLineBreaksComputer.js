 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/strings", "vs/editor/common/core/characterClassifier", "vs/editor/common/viewModel/splitLinesCollection"], function (require, exports, strings, characterClassifier_1, splitLinesCollection_1) {
    "use strict";
    ...
    class MonospaceLineBreaksComputerFactory {
        ...
        static create(options) {
            return new MonospaceLineBreaksComputerFactory(options.get(107 /* wordWrapBreakBeforeCharacters */), options.get(106 /* wordWrapBreakAfterCharacters */));
        }
...
//# __sourceMappingURL=monospaceLineBreaksComputer.js.map