 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/editor/common/viewModel/splitLinesCollection", "vs/editor/common/core/stringBuilder", "vs/base/common/strings", "vs/editor/browser/config/configuration"], function (require, exports, splitLinesCollection_1, stringBuilder_1, strings, configuration_1) {
    "use strict";
    ...
    function createLineBreaks(requests, fontInfo, tabSize, firstLineBreakColumn, wrappingIndent) {
        ...
        const sb = stringBuilder_1.createStringBuilder(10000);
...
//# __sourceMappingURL=domLineBreaksComputer.js.map