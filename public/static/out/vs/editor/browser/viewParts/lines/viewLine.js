...
define(["require", "exports", "vs/base/browser/browser", "vs/base/browser/fastDomNode", "vs/base/common/platform", "vs/editor/browser/viewParts/lines/rangeUtil", "vs/editor/common/view/renderingContext", "vs/editor/common/viewLayout/lineDecorations", "vs/editor/common/viewLayout/viewLineRenderer", "vs/platform/theme/common/themeService", "vs/editor/common/config/editorOptions"], function (require, exports, browser, fastDomNode_1, platform, rangeUtil_1, renderingContext_1, lineDecorations_1, viewLineRenderer_1, themeService_1, editorOptions_1) {
            ...
            if (alwaysRenderInlineSelection || options.themeType === themeService_1.HIGH_CONTRAST || this._options.renderWhitespace === 'selection') {
                ...
                for (const selection of selections) {
                    ...
                    if (startColumn < endColumn) {
                        if (options.themeType === themeService_1.HIGH_CONTRAST || this._options.renderWhitespace !== 'selection') {
    ...
    class RenderedViewLine {
        ...
        _actualReadPixelOffset(domNode, column, context) {
            ...
            const r = rangeUtil_1.RangeUtil.readHorizontalRanges(this._getReadingTarget(domNode), partIndex, charOffsetInPart, partIndex, charOffsetInPart, context.clientRectDeltaLeft, context.endNode);
            if (!r || r.length === 0) {
                return -1;
            }
        ...
        _readRawVisibleRangesForRange(domNode, startColumn, endColumn, context) {
            ...
            return rangeUtil_1.RangeUtil.readHorizontalRanges(this._getReadingTarget(domNode), startPartIndex, startCharOffsetInPart, endPartIndex, endCharOffsetInPart, context.clientRectDeltaLeft, context.endNode);
        }
        /**
...
//# __sourceMappingURL=viewLine.js.map