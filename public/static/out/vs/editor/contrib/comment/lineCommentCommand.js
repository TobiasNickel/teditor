...
define(["require", "exports", "vs/base/common/strings", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/contrib/comment/blockCommentCommand"], function (require, exports, strings, editOperation_1, position_1, range_1, selection_1, languageConfigurationRegistry_1, blockCommentCommand_1) {
    ...
    class LineCommentCommand {
        constructor(selection, tabSize, type, insertSpace) {
         ...
         */
        static _analyzeLines(type, insertSpace, model, lines, startLineNumber) {
         ...
         */
        static _gatherPreflightData(type, insertSpace, model, startLineNumber, endLineNumber) {
...
//# __sourceMappingURL=lineCommentCommand.js.map