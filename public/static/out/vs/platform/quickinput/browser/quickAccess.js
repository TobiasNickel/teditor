...
define(["require", "exports", "vs/platform/quickinput/common/quickInput", "vs/base/common/lifecycle", "vs/platform/quickinput/common/quickAccess", "vs/platform/registry/common/platform", "vs/base/common/cancellation", "vs/platform/instantiation/common/instantiation", "vs/base/common/functional"], function (require, exports, quickInput_1, lifecycle_1, quickAccess_1, platform_1, cancellation_1, instantiation_1, functional_1) {
    "use strict";
    ...
    let QuickAccessController = class QuickAccessController extends lifecycle_1.Disposable {
        ...
        registerPickerListeners(picker, provider, descriptor, value, disposables) {
            ...
            functional_1.once(picker.onDidHide)(() => {
