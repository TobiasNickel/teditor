...
define(["require", "exports", "vs/platform/quickinput/common/quickInput", "vs/platform/quickinput/common/quickAccess", "vs/platform/registry/common/platform", "vs/nls", "vs/base/common/lifecycle"], function (require, exports, quickInput_1, quickAccess_1, platform_1, nls_1, lifecycle_1) {
    "use strict";
    ...
    let HelpQuickAccessProvider = class HelpQuickAccessProvider {
        ...
        provide(picker) {
            ...
            picker.items = editorProviders.length === 0 || globalProviders.length === 0 ?
                ...
                // With groups
                [
                    { label: nls_1.localize('globalCommands', "global commands"), type: 'separator' },
                    ...globalProviders,
                    { label: nls_1.localize('editorCommands', "editor commands"), type: 'separator' },
                    ...editorProviders
                ];
            return disposables;
        }
            ...
            for (const provider of this.registry.getQuickAccessProviders().sort((providerA, providerB) => providerA.prefix.localeCompare(providerB.prefix))) {
                ...
                for (const helpEntry of provider.helpEntries) {
                    ...
                    (helpEntry.needsEditor ? editorProviders : globalProviders).push({
                        prefix,
                        label,
                        ariaLabel: nls_1.localize('helpPickAriaLabel', "{0}, {1}", label, helpEntry.description),
...
//# __sourceMappingURL=helpQuickAccess.js.map